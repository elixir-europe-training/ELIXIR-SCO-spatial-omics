...
The container images for each practical for each practical are in the `sibswiss` namespace on dockerhub, find them [here](https://hub.docker.com/r/sibswiss/elixir-sco-spatial-omics/tags). In order to use them locally for e.g. practical 6, you can use the following command:
